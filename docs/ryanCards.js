var timelineCards2 = [
    ...
    {
        "date": "2023-01-31",
        "title": "Competenties van de Minor",
        "point": "week&nbsp05",
        "imgSrc": "PersoonlijkR/wordcloudCompetatnies.png",
        "imgAlt": "",
        "desc": `Voor de MSI minor zijn de volgende competeneties van belang, deze heb ik in kaart gebracht. <br>
        <ul><li>
        beschrijft de mate van volwassenheid van een organisatie m.bt. Smart Industry in een business case;
          </li><li>
        communiceert op effectieve wijze zijn bevindingen naar verschillende doelgroepen; werkt actief aan zijn professionele ontwikkeling;
          </li><li>        
        ...
        past nieuwe technologieën op het gebied van IoT, Robotica en 3D-printen toe op een praktijkcasus;
          </li><li>
        plaatst de casus in een business context;
          </li><li>
        ontwerpt bedrijfsprocessen volgens Smart Industry criteria, beschrijft de implicaties voor het gehele businessmodel en voor de positie van de organisatie keten;
          </li><li>
        ontwikkelt een prototype van de oplossing(srichting);
          </li><li>
        draagt vanuit verschillende rollen bij aan het succes van een projectteam, communiceert op effectieve wijze met alle betrokkenen;
          </li><li>
        draagt actief bij aan een optimale werksfeer binnen en buiten zijn team, ontwikkelt een professioneel netwerk
            </li></ul>`,
...
const timelineCards = timelineCards2.sort(function (a, b) {
